...
class TradingEnv_withoutPortfolio(gymnasium.Env):
    ...
    def __init__(self, data: pd.DataFrame, initial_cash: float = 10_000, window_size: int = 14, scaler_path: str = "../Transform_data/scaler.pkl", default_seed: int = 42):
        ...
        obs_shape = (self.window_size, len(self.data.columns))  # statt +3
...
TradingEnv_withoutPortfolio.seed = seed
...
TradingEnv_withoutPortfolio.reset = reset
...
TradingEnv_withoutPortfolio.step = step
...
def _next_observation(self) -> np.ndarray:
    ...
    observation = market_data_window  # Nur Marktdaten, ohne Portfolio-Infos

    return observation

TradingEnv_withoutPortfolio._next_observation = _next_observation
...
TradingEnv_withoutPortfolio._check_done = _check_done
...
TradingEnv_withoutPortfolio._calculate_reward = _calculate_reward
...
TradingEnv_withoutPortfolio.get_action_mask = get_action_mask
...
TradingEnv_withoutPortfolio._execute_trade = _execute_trade
...
TradingEnv_withoutPortfolio._buy = _buy
...
TradingEnv_withoutPortfolio._sell = _sell
...
TradingEnv_withoutPortfolio._denormalize_return = _denormalize_return
...
TradingEnv_withoutPortfolio.calculate_buy_and_hold = calculate_buy_and_hold
...
TradingEnv_withoutPortfolio.render = render
